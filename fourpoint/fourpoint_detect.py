...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train_foupoint_720p/exp22/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/data0/TILT/720p/images', help='source')  # file/folder, 0 for webcam
