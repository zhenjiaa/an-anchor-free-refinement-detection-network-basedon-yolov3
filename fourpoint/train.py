...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='cfg/ccpd/box_720p.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/train_foupoint_720p', help='save to project/name')
