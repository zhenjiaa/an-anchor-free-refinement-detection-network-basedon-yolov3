...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/data1/diedai/yolov3/runs/train_1080p_yolov3_2/exp/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='cfg/ccpd/box_1080p.yaml', help='*.data path')
