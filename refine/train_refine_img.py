...
from refine.yolo_from_img import  detector, refine_yolo
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='free_yolo/free-yolov3_fromimg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='cfg/ccpd/box_1080p.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/train_1080p_img', help='save to project/name')
