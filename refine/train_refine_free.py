...
from refine.yolo_refine_free import  detector, refine_yolo
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if pretrained:
        ...
        detector_args={}
        detector_args['conf_thres']=0.3
        detector_args['iou_thres']=0.3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='runs_new/train_1080p_res_free_03_01', help='save to project/name')
